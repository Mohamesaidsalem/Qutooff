...
import { AddChildFormData } from '../types/AddChildForm';
...
export default function AddChildForm({ isOpen, onClose, onSubmit }: AddChildFormProps) {
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof AddChildFormData, string>>>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<Record<keyof AddChildFormData, string>> = {};
